...
namespace AirQualityApp.Server.Controllers
{
    ...
    public class AirQualityController : ControllerBase
    {
        ...
        public List<AirQualityCityData?> GetAirQualityDataByCity(string cityName, int limitDays = 3)
        {
            throw new NotImplementedException();
        }
        ...
        public List<(DateTime, List<AirQualityAreaData>)> GetAirQualityAreasDataByCity(string cityName, List<int> areaIds, int limitDays = 3)
        {
            throw new NotImplementedException();
        }
